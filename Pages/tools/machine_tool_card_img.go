...
// 单选题卡片（有图片）- 附带图片，横向排列
func NewCardSingleChoiceWithImg(questionNumber int, question string, options []string, imgPaths []string, onAnswered func(int), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
...
// 多选题卡片（有图片）- 附带图片，横向排列
func NewCardMultiChoiceWithImg(questionNumber int, question string, options []string, imgPaths []string, onAnswered func([]int), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
...
// 填空题卡片（有图片）- 附带图片，横向排列
func NewCardFillBlankWithImg(questionNumber int, question string, blanks int, imgPaths []string, onAnswered func([]string), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
...
func NewCardSCIMG(questionNumber int, question string, options []string, imgPaths []string, onAnswered func(int), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
	radioContainer := createWrappedRadioGroupForImage(options, func(selected string) {
		for i, opt := range options {
			if opt == selected {
				onAnswered(i)
	...
	if len(imgPaths) > 0 {
		imgLayout = createQuestionImageLayout(imgPaths, 980, window) // 卡片宽度980
	} else {
...
func NewCardMCIMG(questionNumber int, question string, options []string, imgPaths []string, onAnswered func([]int), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
	selected := make([]bool, len(options))
...
func NewCardFLIMG(questionNumber int, question string, blanks int, imgPaths []string, onAnswered func([]string), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
	entries := make([]*widget.Entry, blanks)
	box := container.NewVBox()
