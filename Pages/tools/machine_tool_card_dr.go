...
func DRQuestionCard(questionNumber int, question ExamQuestion, onAnswered func(string, []string), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
...
func DRGroupCard(drQuestion ExamQuestion, childQuestions []ExamQuestion, onChildAnswered func(string, []string), window fyne.Window, getLocalized func(string) string) fyne.CanvasObject {
